...
<template>
    <nav class="bg-black text-white sticky top-0 z-50 shadow-lg w-full">
        <div class="flex justify-between items-center px-4 lg:px-18 py-4">
            <a href="/" class="flex items-center gap-1 lg:w-64 z-50">
                ...
                <div class="font-bold text-2xl tracking-wide">Locul Tau</div>
            </a>
            <div
            ...
            >
                <ul class="flex flex-col lg:flex-row gap-6 lg:gap-6 items-center">
                    <li><a href="/events" class="hover:text-yellow-300 lg:duration-300">Concerte</a></li>
                ...
                <ul class="flex flex-col md:flex-row justify-end gap-4 items-center p-4 lg:p-1 lg:mt-0 w-full lg:w-auto">
                    <li class="w-full md:w-1/2 text-center "><a href="#" class="block hover:border-white border py-2 px-4 rounded-full border-gray-400 lg:duration-300">Autentificare</a></li>
                    <li class="w-full md:w-1/2 text-center"><a href="#" class="block hover:bg-green-600 py-2 px-4 rounded-full bg-green-700 lg:duration-300">Inregistare</a></li>
                </ul>
            </div>
